...
<div class="col-sm-8 col-sm-offset-3 col-lg-offset-2 main"> 
    ...
    <div class="signup-form-container  " style=" box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);" >
         ...
         <div class="form-header " >
         	<h3 class="form-title"><i class="fa fa-user"></i> Demande </h3>
...
<br> <br> <br>
              <div class="form-group" >
                   ...
                   <textarea name="NOM"  class="form-control" rows="2" placeholder="Nom"></textarea>
                   </div>
         	  ...
         	  <div class="form-group" >
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <textarea name="PRENOM"  class="form-control" rows="2" placeholder="Prenom"></textarea>
                   </div>
                   <span class="help-block" id="error"></span>
              </div>
              ...
              <div class="form-group">
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <textarea name="NUM_REGISTRE"  class="form-control" rows="2" placeholder="Numero du Registre"></textarea>
                   </div> 
                   <span class="help-block" id="error"></span>                     
              </div>
			   ...
			   <div class="form-group">
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <textarea name="ANNEE_REGISTRE"  class="form-control" rows="2" placeholder="Année du Registre"></textarea>
                   </div> 
                   <span class="help-block" id="error"></span>                     
              </div>
			  ...
			  <div class="form-group">
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <textarea name="NBR_COPIES"  class="form-control" rows="2" placeholder="Nombre de copies"></textarea>
                   </div> 
                   <span class="help-block" id="error"></span>                     
              </div>
			   ...
			   <div class="form-group">
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <textarea name="DATE_RETRAIT"  class="form-control" rows="2" placeholder="Date retrait"></textarea>
                   </div> 
                   <span class="help-block" id="error"></span>                     
              </div>
